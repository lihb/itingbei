...
public class WaveSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void initDraw() {
        ...
        canvas.drawCircle(0, getHeight() - line_off / 4, line_off / 4, circlePaint);// 下面小圆
        canvas.drawLine(0, 0, 0, getHeight(), circlePaint);//垂直的线
...
//    	         canvas.drawLine(0, height*0.75f+20, sfv.getWidth(),height*0.75f+20, paintLine);//第3根线
        canvas.drawLine(0, height * 0.5f + line_off / 2, getWidth(), height * 0.5f + line_off / 2, centerLine);//中心线
