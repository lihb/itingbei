...
import com.lihb.babyvoice.fragment.HeartFragment;
import com.lihb.babyvoice.fragment.MeFragmentNew;
import com.lihb.babyvoice.fragment.PersonalInfoFragment;
import com.lihb.babyvoice.fragment.WebViewFragment;
...
//        mData.get(3).itemUrl = Constant.MY_CARD_INFO;
    ...
    private boolean getCanExit() {
        ...
        if (getSupportFragmentManager().findFragmentByTag("BabyInfoFragment") != null &&
                getSupportFragmentManager().findFragmentByTag("BabyInfoFragment").isVisible()) {
            return false;
        }
        if (getSupportFragmentManager().findFragmentByTag("PersonalInfoChangeFragment") != null &&
                getSupportFragmentManager().findFragmentByTag("PersonalInfoChangeFragment").isVisible()) {
            return false;
        }
        if (getSupportFragmentManager().findFragmentByTag("PersonalInfoFragment") != null &&
                getSupportFragmentManager().findFragmentByTag("PersonalInfoFragment").isVisible()) {
            return false;
        }
        if (getSupportFragmentManager().findFragmentByTag("VoicePlayFragment") != null &&
                getSupportFragmentManager().findFragmentByTag("VoicePlayFragment").isVisible()) {
            return false;
        }
        if (getSupportFragmentManager().findFragmentByTag("VoiceRecordFragment") != null &&
                getSupportFragmentManager().findFragmentByTag("VoiceRecordFragment").isVisible()) {
            return false;
        }
        if (getSupportFragmentManager().findFragmentByTag("VoiceRecordFragmentV2") != null &&
                getSupportFragmentManager().findFragmentByTag("VoiceRecordFragmentV2").isVisible()) {
            return false;
        }
        if (getSupportFragmentManager().findFragmentByTag("VoiceSaveFragment") != null &&
                getSupportFragmentManager().findFragmentByTag("VoiceSaveFragment").isVisible()) {
            return false;
        } else {
            return true;
        }
