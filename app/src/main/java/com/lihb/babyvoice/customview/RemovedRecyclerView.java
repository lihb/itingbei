...
import com.lihb.babyvoice.adapter.HeartViewHolder;
...
public class RemovedRecyclerView extends BaseRecyclerView {
    ...
    public RemovedRecyclerView(Context context) {
        this(context, null);
    }

    public RemovedRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RemovedRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    HeartViewHolder viewHolder = (HeartViewHolder) getChildViewHolder(view);

                    mItemLayout = viewHolder.voice_layout;
                    mPosition = viewHolder.getAdapterPosition();

                    mDelete = (TextView) mItemLayout.findViewById(R.id.voice_delete_txt);
