...
package com.lihb.babyvoice.view.cropper.util;
...
public class ImageViewUtil {
    ...
    public static boolean setImageBitmap(ImageView imageView, byte[] data, float scale) {
        if (imageView == null || data == null || scale <= 0) {
            return false;
        }
